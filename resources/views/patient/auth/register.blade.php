                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Register as Patient!</h1>
                                    </div>
                                    <form class="user" method="post" action="{{route('patient.register')}}" id="doctorRegisterForm">
                                        @csrf
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{route('patient.login')}}">Already have an account?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
